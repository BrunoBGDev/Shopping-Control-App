...
function setList(list){
    var table = '<thead><tr><td>Produto</td><td>Quantidade</td><td>Valor</td><td>Opção</td></tr></thead>';
    for(var key in list){
...
function deleteList() {
    if(confirm("Deletar a lista completa?")){
        list = [];
        setList(list);
    }
}
